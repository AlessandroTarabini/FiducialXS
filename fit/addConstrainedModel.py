...
_temp = __import__('inputs_sig_'+obsName+'_'+opt.YEAR, globals(), locals(), ['acc','eff','deff','outinratio','doutinratio','inc_wrongfrac','binfrac_wrongfrac'], -1)
acc = _temp.acc
eff = _temp.eff
err_eff = _temp.deff
outinratio = _temp.outinratio
err_outinratio = _temp.doutinratio
